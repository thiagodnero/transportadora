...
(1, 'Objeto postado'),
(2, 'Objeto recebido na unidade de distribuição'),
(3, 'Objeto encaminhado para'),
(4, 'Objeto recebido na unidade de distribuição'),
(5, 'Objeto aguardando rota de entrega'),
(6, 'Objeto em rota de entrega'),
(7, 'Entrega não pode ser efetuada');

CREATE TABLE `rastreios` (
  `id` int(11) NOT NULL,
  `cidade_origem` varchar (75) DEFAULT NULL,
  `cidade_destino` varchar (75) DEFAULT NULL,
