            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Gerar código simples</h6>
                    </div>
                    <div class="card-body">
                        <button onclick="setTrackingBasic()">Gerar código</button><br><br>
                        <form action="registraCodigoBsc.php" method="post" id="form-buscar1" class="ajax">

                            <label for="Tracking">Numero do rastreio:</label><br>
                            <input type="text" id="nmr_rastreio_bsc" name="nmr_rastreio"><br><br>
