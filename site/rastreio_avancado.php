                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Rastreio Avançado</h6>
                        </div>
                        <div class="card-body">
                            <form action="registraCodigoAdv.php" method="post" id="form-buscar1" class="ajax">

                                <label for="Tracking">Numero do rastreio:</label><br>
                                <input type="text" id="nmr_rastreio_adv" name="nmr_rastreio">
                                <button type="button" onclick="setTrackingAdvanced()" class="btn btn-secondary btn-sm">Gerar codigo</button><br><br>
                                ...
                                <input type="submit" value="Gerar rastreio" class="btn btn-warning">
                            </form>
                        </div>
                    </div>
