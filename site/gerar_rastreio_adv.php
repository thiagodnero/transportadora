...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="gerar_rastreio_basic.php">Basico</a>
                        <a class="collapse-item" href="gerar_rastreio_adv.php">Avançado</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $id_usr ?></span>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Gerar código avançado</h6>
                    </div>
                    <div class="card-body">
                        <button onclick="setTrackingAdvanced()">Gerar codigo</button><br><br>
                        <form action="registraCodigoAdv.php" method="post" id="form-buscar1" class="ajax">

                            <label for="Tracking">Numero do rastreio:</label><br>
                            <input type="text" id="nmr_rastreio_adv" name="nmr_rastreio"><br><br>
                            ...
                            <label for="dateTime">Data/Hora:</label><br>
                            <input type="datetime-local" id="date" name="date"><br><br>

                            <label for="email">Email:</label><br>
                            <input type="text" id="email" name="email"><br><br>

                            <input type="submit" value="Gerar rastreio">
                        </form>
                    </div>
                </div>
                <!-- /.container-fluid -->
    ...
    <script>
        function setTrackingAdvanced() {
            ...
            document.getElementById("nmr_rastreio_adv").value = stringAleatoria;
        }
    </script>
